                ...
                >
                    <div
                        style={{
                            ...
                            background:
                                "linear-gradient(180deg,#fa8128,#dc670e)",
  ...
  `;
                ...
                >
                    <div
                        style={{
                            ...
                            flexShrink: 0,
                            background:
                                "linear-gradient(135deg,#fa8128,#dc670e)",
                            display: "flex",
                            alignItems: "center",
        ...
        <div style={{ width: "100%" }}>
            ...
            {isMobile ? (
                ...
                >
                    ...
                    >
                        {["Discount", "Date", "Sold / Cap", "Status", ""].map(
                            (h, i) => (
                                <span
                                    key={i}
                                    style={{
    ...
    const SettingsView = () => (
        ...
        >
            ...
            {["Organizer Name", "Contact Email", "Phone Number"].map(
                (label, i) => (
                    <div key={i} style={{ marginBottom: "13px" }}>
                        <label
                            style={{
