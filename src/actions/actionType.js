...
export const SET_PENDING_REDIRECT = "SET_PENDING_REDIRECT";  // ← added
...
export const UPDATE_DISCOUNT_LIKES = "UPDATE_DISCOUNT_LIKES";
export const SET_DISCOUNT_LIKED = "SET_DISCOUNT_LIKED";
export const UPDATE_ORGANIZER_FOLLOWERS = "UPDATE_ORGANIZER_FOLLOWERS";
...
export const USER_DISCOUNT_LIKES = "USER_DISCOUNT_LIKES";
export const REMOVE_USER_DISCOUNT_LIKE = "REMOVE_USER_DISCOUNT_LIKE";
export const ADD_USER_DISCOUNT_LIKE = "ADD_USER_DISCOUNT_LIKE";